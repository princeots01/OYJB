...
export default function SaveJobScreen() {
    ...
    <View style={{ flex: 1, backgroundColor: bg }}>
      ...
      <View style={[styles.topBar, { backgroundColor: bg }]}>
        <Image
          ...
          resizeMode="contain"
        />
        <Text style={[styles.topTitle, { color: textColor }]}>Saved Jobs</Text>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {savedJobs.length === 0 && (
          <View style={styles.noResultWrapper}>
            <Ionicons name="briefcase-outline" size={70} color={iconDim} />
            <Text style={[styles.noResultText, { color: iconDim }]}>
              No Saved Jobs
            </Text>
            <Text style={[styles.noResultSub, { color: iconDim }]}>
              Browse jobs and tap the save icon to add them here.
            </Text>
          </View>
        )}
      ...
      >
        <TouchableOpacity onPress={() => router.push("/homeScreen")}>
          <Ionicons name="home-outline" size={26} color={isDark ? "#fff" : "#777"} />
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => router.push("/notifications")}>
          <Ionicons name="notifications-outline" size={26} color={iconDim} />
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  modalContent: { borderRadius: 12, width: "80%" },
  modalOption: {
    padding: 16,
    borderBottomWidth: 1,
  },
